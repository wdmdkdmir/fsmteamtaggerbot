...
async def help(event):
  helptext = "**FSM TEAM TAGGER bot'un Yardım Menüsü**\n\nKomut: /all \n  Bu komutu, başkalarına bahsetmek istediğiniz metinle birlikte kullanabilirsiniz. \n`Örnek: /all Günaydın!`  \nBu komutu yanıt olarak kullanabilirsiniz. herhangi bir mesaj Bot, yanıtlanan iletiye kullanıcıları etiketleyecek"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/FSMTEAMTAG_bot?startgroup=a'),
                       Button.url('📣 Support', 'https://t.me/illegalizmChat'),
                      Button.url('🚀 Sahibim', 'https://t.me/IAMMEMOOKK')]
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalıyor merak etme 🚀 @IAMMEMOOKK bilgi alabilirsin <<")
